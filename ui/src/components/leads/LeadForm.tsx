...
const LeadForm: React.FC<LeadFormProps> = ({ lead, onSubmit, isSubmitting, onAutofill, isAutoFilling }) => {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <FormField
                    ...
                    name="linkedin_url"
                    render={({ field }) => (
                        <FormItem className="w-full flex items-end gap-5 justify-start">
                            ...
                            <Button onClick={() => onAutofill(field.value)} type="button" disabled={isAutoFilling}>
                ...
                <div className="flex justify-end">
                    <Button type="submit" disabled={isSubmitting}>
                        {isSubmitting ? "Saving..." : lead?._id ? "Update Lead" : "Create Lead"}
                    </Button>
                </div>
            </form>
        </Form>
